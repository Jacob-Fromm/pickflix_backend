...
def get_random_movies
    page_num = 1
    random_genre_ids_string = $all_genre_ids.sample(10).join(",")
    randomly_selected_movies = unogs_request(random_genre_ids_string, page_num)
    byebug
end
...
def unogs_request(genre_id_string, page_num)
    ...
    frankenstein_movies = create_movie_objects(readable_response)
